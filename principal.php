...
if (isset($_POST['caso'])) {
  if ($_POST['caso'] == "") {
    $msg.= "Debe ingresar un caso";
  }else{
    $caso = strip_tags($_POST['caso']);
  ...
  $mysqli->query("INSERT INTO `casos` (`casos_text`,`casos_direccion`)
                  VALUES ('".$caso."','".$ip."');");
}
}
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Prueba PHP </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-8">
            <form action="principal.php" method="post">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title"><b>Descripción del caso</b></h5><br>
                <input type="text" name="caso" size = "100"><br><br>
                <div class="col-4">
